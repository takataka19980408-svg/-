...
interface Props {
  onSwitchToBaccarat: () => void;
}

export default function PersonalApp({ onSwitchToBaccarat }: Props) {
  ...
  return (
    <>
      ...
      {screen === 'settings' && <SettingsScreen onDataChange={() => setRefreshKey(k => k + 1)} onSwitchToBaccarat={onSwitchToBaccarat} />}
